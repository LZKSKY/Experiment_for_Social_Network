-LRB- CNET -RRB- -- Coming from a company known more for its plasma HDTVs , the Panasonic TC-32LX85 is a pleasant surprise in the 32-inch LCD category .

Attractively designed and well appointed with generous connectivity , it is also a good performer overall , although by no means perfect . I was particularly impressed with the set 's color accuracy , which is something I really do n't expect from entry-level displays .
...
In the Advanced menu there are two varieties of noise reduction , called Video NR and MPEG NR , and for high-quality sources both should be turned-off . Black Level should be set to Light for full shadow detail , although intuitively I would think Dark would be correct . -LRB- Panasonic always had Lighter and Darker settings that were intuitively correct at 7.5 and 0 IRE respectively in their DVD players . Strangely , for their TVs , it is backward . -RRB-
...
I did n't have to make too many adjustments during the user menu calibration to get the little TV looking its best . Since there are no custom color temperature controls in the user menu , I simply chose the best picture mode -LRB- Custom -RRB- and color temperature preset -LRB- Warm -RRB- and then tweaked the remainder of the basic picture controls .
...
Video processing : Unlike most modern HDTVs the LC-32LX85 does n't accept 1080p sources , so my evaluation had to be with all HD sources set to 1080i . The set lacks an aspect ratio that provides for zero overscan , which would be a bigger issue if it were a 1080p resolution panel , but really is n't a big deal the panel has only a 720p resolution . The video processing does roll off the high-frequency video somewhat , a common flaw with many flat-panel sets on the market today .
...
Standard-definition : The Panasonic is a mediocre performer with standard-def material . It did n't resolve every line of horizontal resolution according to the charts on the HQV disc , and as a result some images appeared a bit softer than normal .
...
PC : Absent a VGA-style PC input I attempted to test the Panasonic 's capability to handle digital signals from a PC via its HDMI jack . The best resolution the video card allowed was 1,280 x768 , which is short of the set 's native resolution , and there was enough overscan that important areas of the screen , including the Windows taskbar , were obscured . People who want a PC display should probably choose another set .
